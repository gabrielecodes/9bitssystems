...
export default function Contact() {
  return (
    <section id="contact" className="w-full xl:h-screen xl:p-10 px-2 xl:flex xl:flex-col text-foreground selection:bg-blue-neon selection:text-background">
      <h1 className={`${serif.className} w-fit px-2 text-center inline-block transform bg-foreground text-background font-semibold`} >
        Contact
      </h1>

      <div id="contact" className="xl:w-2/3 w-full xl:mt-20 mx-auto flex justify-center items-center">
        <div className="w-full h-fit xl:p-12 p-6 m-auto flex xl:flex-row flex-col items-start justify-center gap-x-4">
