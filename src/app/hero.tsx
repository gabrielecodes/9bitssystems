  ...
  return (
    <section className="w-full h-full flex xl:flex-row flex-col">
      ...
      <div className="xl:w-1/2 xl:h-full h-1/2 flex flex-col items-end justify-end relative">
        <p className="absolute bottom-12">I've called this space of the web</p>
        <span className="styro text-5xl scale-x-250 tracking-wide absolute bottom-0 right-20">NINE BITS</span>
      </div>
    </section>
  );
}
