...
export default function Home() {
  return (
    <main className="select-none bg-[url('/bg3.jpg')]">
      ...
      <SectionOuter>
        <SectionInner className="gap-x-0 xl:px-0 px-3">
          ...
          <h2 className="col-start-2 col-span-1 flex items-center">
            <span className="w-full text-center mx-auto inline-block transform bg-foreground text-background font-semibold">
              How I Work
            </span>
          </h2>
          <div className="h-20 xl:col-span-8"></div>
          <div className="h-full col-start-2 col-span-6 grid grid-cols-6 crossed-lines-gradient border-y border-neutral-200">
            <div className="my-8 p-8 col-start-2 col-span-4 bg-white border-y border-r border-neutral-200 shadow-lg">
              <h3 className="w-full xl:col-start-3 xl:col-span-3 flex items-start text-justify leading-8">
                I craft solutions that prioritize your goals, drawing on over a decade of experience as a data
                strategist across diverse industries, including fintech. I build systems that enable your teams to move
                faster — not lock them into complexity. Many businesses are dragged down by unreliable technology and
                broken processes &mdash; I help you untangle the complexity and build systems that actually work for
                you.
              </h3>
