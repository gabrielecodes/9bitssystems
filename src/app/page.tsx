...
export default function Home() {
  return (
    ...
    <main className="w-full min-h-screen select-none">
      <SectionOuter className="border-t-0">
        <SectionInner>
          <Hero />
        </SectionInner>
      </SectionOuter>
      ...
      <SectionOuter>
        <SectionInner className="xl:h-fit gap-x-0">
          ...
          <h2 className="h-20 ml-2 col-start-2 col-span-6">
            <span className="px-4 inline-block transform -skew-x-12 bg-neutral-800 text-background xl:shadow">
              <span className="font-semibold inline-block skew-x-12">Our Services</span>
            </span>
          </h2>
          {/* Service 1 */}
          <div className="max-w-4/5 xl:max-w-full xl:w-full h-[34rem] mt-20 p-6 col-start-2 col-span-2 border-y border-x xl:border-r xl:border-r-0 xl:border-l-0 border-neutral-200 bg-background">
          ...
          {/* Service 2 */}
          <div className="max-w-4/5 xl:max-w-full xl:w-full h-[34rem] xl:mt-20 p-6 col-start-2 col-span-2 xl:border-y xl:border-b-0 border-b border-x xl:border-r xl:border-r-0 xl:border-l-0 border-neutral-200 bg-background">
